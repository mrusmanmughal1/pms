...
router.post("/forgotpassword", async (req, res) => {
  try {
    ...
    // Since we don't have a real SMTP configured, we just log the token to the console
    // In production, we would use nodemailer to send the reset URL to user.email
